...
module.exports = async (user, mailType, admin) => {
  try {
    ...
    if (mailType === "afterreset") {
      ...
      emailContent = `<div><h1>Please click on the below link to reset your password</h1> <a href="https://motorcycle-servicing-company.netlify.app/resetpassword/${encryptedToken}">${encryptedToken}</a> </div>`;
