...
module.exports = async (user, mailType) => {
  try {
    ...
    if (mailType === "verifyemail") {
      emailContent = `<div><h1>Please click on the below link to verify your email address</h1> <a href="https://motorcycle-servicing-company.netlify.app/verifyemail/${encryptedToken}">${encryptedToken}</a>  </div>`;
